...
import { SimulationState, Scenario, WeatherData, CarbonData } from '@/simulation/types';
...
interface SimulationContextType {
    ...
    toggleStationFailure: (stationId: string) => void;
...
export function SimulationProvider({ children }: { children: ReactNode }) {
    ...
    // Initialize engine and load data (only once)
    useEffect(() => {
    ...
    const resetScenario = useCallback(() => {
        engineRef.current?.resetScenario();
    }, []);
